...
public class MenuParticipantesDao extends BaseDao {
    ...
    public ArrayList<BParticipante> listarParticipantesSinUniFiltradoPorPais(int idPais) {

        ArrayList<BParticipante> listaParticipantes = new ArrayList<>();

        String sql = "SELECT * FROM lab9.participantes where Alumno_idAlumno is NULL and Paises_idPaises = ?";
    ...
    public BParticipante obtenerParticipantePorIdAlumno(int id) {

        BParticipante participante = new BParticipante();

        String sql = "SELECT * FROM lab9.participantes where Alumno_idAlumno = ?;";
